  ...
  return (
    <div className="flex min-h-screen justify-center items-center pt-40">
      <div className="flex flex-col gap-5 justify-center items-center max-w-full w-full">
                <h1 className="text-white text-5xl md:text-7xl lg:text-8xl font-bold text-center">Confira nossa galeria no menu de navegação</h1>
                <p className="text-2xl lg:text-4xl text-[#828282] text-center">Ou clique na imagem abaixo</p>
